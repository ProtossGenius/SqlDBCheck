...
public class DBChecker {
     ...
     * @throws SQLException
     */
    public void singleValueCheck(LineData lineData, String tableName, String colName, String value) throws SQLException {
        loader.checkStringVal(lineData, tableToCheck, tableName, colName, value);
    }

    /**
     * Maybe some more complicated queries
     *
     * @param lineData for error output get more info.
     * @param tableName
     * @param condition The part after the sql statement's "where" keyword
     * @throws SQLException
     */
    public void conditionCheck(LineData lineData, String tableName, String condition) throws SQLException {
        loader.checkValExist(lineData, tableToCheck, tableName, condition);
    }
